...
let
  ...
  # Defines the options for all doom options. These will be translated to the arguments of
  # the `doom!` macro.
  doomCategoryOptions = {
    input = {
  ...
  # The arguments to the doom! macro.
  doomInitArgs =
    let
      categories = [
        "completion"
...
in
{
  options.init = mkOption {
    description = "The doom config init.el file.";
