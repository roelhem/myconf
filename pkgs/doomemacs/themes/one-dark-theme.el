;;; one-dark-theme.el --- Description -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
;; Homepage: https://github.com/roel/one-dark-theme
  ...
  ;;;; Base theme face overrides
   ...
   ;;;; font-lock
                 ...
                 (font-lock-misc-punctuation-face
                  :foreground teal)
                 (rh-font-lock-template-string-face
                  :foreground avocado)
                 (rh-font-lock-constructor-face
                  :foreground constructors)
                 (rh-font-lock-implicit-constructor-face
                  :foreground (doom-darken magenta 0.05))
                 (rh-font-lock-label-face
                  :slant 'italic
                  :weight 'medium
                  :foreground magenta)
                 (rh-font-lock-builtin-type-face
                  :weight 'bold
                  :foreground magenta)
                 (rh-font-lock-namespace-name-face
                  :weight 'medium
                  :foreground orange)
   ;;;; tree-sitter
   ...
   ;;;; vue-ts-mode
                 (vue-ts-mode-template-tag-bracket-face
                  :foreground (doom-darken blue 0.1))
                 (vue-ts-mode-html-tag-face
                  :foreground cyan)
                 (vue-ts-mode-directive-modifier-face
                  :foreground avocado)
   ;;;; haskell-mode
